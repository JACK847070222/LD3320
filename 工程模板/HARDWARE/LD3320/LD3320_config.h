...
#define LD_RST_H() 						GPIO_SetBits(GPIOB, GPIO_Pin_0)
#define LD_RST_L() 						GPIO_ResetBits(GPIOB, GPIO_Pin_0)

#define LD3320CS_PIN					GPIO_Pin_0		
#define LD3320CS_GPIO_PORT		GPIOA
#define LD3320CS_GPIO_CLK			RCC_APB2Periph_GPIOA
#define LD_CS_H()							GPIO_SetBits(GPIOA, GPIO_Pin_0)
#define LD_CS_L()							GPIO_ResetBits(GPIOA, GPIO_Pin_0)
...
#define LD_SPIS_H()  					GPIO_SetBits(GPIOB, GPIO_Pin_1)
#define LD_SPIS_L()  					GPIO_ResetBits(GPIOB, GPIO_Pin_1)
